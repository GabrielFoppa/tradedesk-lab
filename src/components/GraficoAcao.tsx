...
interface Props {
  acao: Acao;
  onPrecoAtualizado: () => void; // Bug B3: função vindo de Server Component — não serializável
}
...
export default function GraficoAcao({ acao, onPrecoAtualizado }: Props) {
  ...
  return (
    <div className="card-terminal">
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
        ...
        <button onClick={onPrecoAtualizado} style={{ background: "#1a1a1a", border: "1px solid #333", color: "#e5e5e5", padding: "0.25rem 0.75rem", borderRadius: 4, cursor: "pointer", fontSize: "0.75rem" }}>
          Atualizar
        </button>
      </div>
